...
// Зверніть увагу на використання компонента Suspense у коді компонента сторінки About.
//   Так, при завантаженні підсторінок, не заново малюватиметься вся сторінка, лише її нижня частина з розміткою підсторінок.
// Компоненти Suspense у SharedLayout та About не заважають один одному, натомість React використовує найбільш підходящий - той,
//   що найближче до завантажуваного компоненту.